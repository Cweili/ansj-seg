...
public class AnsjArrays {
	...
	private static final Log log = LogFactory.getLog(AnsjArrays.class);
	...
	private static void mergeSort(WoodInterface[] src, WoodInterface[] dest, int low, int high,
			int off) {
		int length = high - low;
